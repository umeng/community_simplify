...
//    private SwitchButton switchButton;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(ResFinder.getLayout("umeng_simplify_setting_activity"));
    ...
    private void initViews() {
        ...
        genderGroup = (RadioGroup)findViewById(ResFinder.getId("genderGroup"));
        manButton = (RadioButton)findViewById(ResFinder.getId("maleButton"));
        womanButton = (RadioButton)findViewById(ResFinder.getId("femaleButton"));
        ...
        headicon.setBackGroundColor(ResFinder.getColor("umeng_comm_color_transparent"));
//        if (TextUtils.isEmpty(user.iconUrl)){
//            headicon.setImageDrawable(ResFinder.getDrawable(""));
//        }else {

        TextView accountTv = (TextView) findViewById(ResFinder.getId("umeng_comm_user_account_tv"));
        if(user != null && !TextUtils.isEmpty(user.sourceUid)){
            accountTv.setVisibility(View.VISIBLE);
            accountTv.setText(user.sourceUid);
        }else {
...
//        }
       ...
       genderGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
        ...
        mSaveButton = (TextView) findViewById(ResFinder.getId("umeng_comm_save_bt"));
    ...
    private boolean checkData() {
        ...
        if (!StringUtil.isWordAndNum(name) || name.length() < 2 || name.length() > 20) {
